...
public class RegiPro extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        java.sql.Timestamp AppTime=new java.sql.Timestamp(date1.getTime());
        ...
        PreState.setTimestamp(9, AppTime);
        ...
        Out.println("<h3><center>Please notedown Your Registration Number for Further Requests:</h3><h1>"+seq+"</h1></center><br><br><center><a href=\"index.jsp\"><image src=\"Home.png\" alt=\"Go To Home Page\" border=\"0\"/></a></center>");
        Out.println("</body>");
        Out.println("</html>");
            }
            else
